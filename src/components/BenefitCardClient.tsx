          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-4 space-y-2">
              <div className="flex items-center text-sm text-gray-600 dark:text-gray-300">
                ...
                <span className="font-medium">{status.benefit.creditCard.displayName}</span>
                <span className="mx-2">•</span>
                <span className="text-gray-500 dark:text-gray-400">{status.benefit.creditCard.issuer}</span>
              </div>
              <div className="flex items-center text-sm text-gray-600 dark:text-gray-300">
                <svg className="h-4 w-4 mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                <span>Cycle ends: <span className="font-medium">{formatDate(status.cycleEndDate)}</span></span>
              </div>
            </div>
          </div>
          ...
          <div className="flex-shrink-0 ml-6">
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={isPending}
                className={`relative px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                  isCompleted
