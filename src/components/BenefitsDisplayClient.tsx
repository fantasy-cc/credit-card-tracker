...
export default function BenefitsDisplayClient({
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6 dark:text-white">Benefits Dashboard</h1>
        ...
        {activeTab === 'upcoming' && (
          <section>
            {upcomingBenefits.length === 0 ? (
              <p className="text-gray-500 dark:text-gray-400">No upcoming benefits found.</p>
            ) : (
        ...
        {activeTab === 'completed' && (
          <section>
            {completedBenefits.length === 0 ? (
              <p className="text-gray-500 dark:text-gray-400">No completed benefits.</p>
            ) : (
              <div className="space-y-4">
