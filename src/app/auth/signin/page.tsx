...
function SignInContent() {
  ...
  const displayError = formError || (error ? getErrorMessage(error) : '');
...
function getErrorMessage(error: string): string {
  const messages: Record<string, string> = {
    ...
    OAuthAccountNotLinked: 'This email is already linked to another provider. Try signing in with the original provider.',
