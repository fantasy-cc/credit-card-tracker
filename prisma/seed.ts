  ...
  const predefinedCardsData: Array<Omit<PrismaPredefinedCard, 'id' | 'createdAt' | 'updatedAt'> & { benefits: BenefitInput[] }> = [
    ...
    },
    {
      ...
      benefits: [
        ...
        {
          description: '$250 x 2 Edit Collection Credit',
          category: 'Dining',
          maxAmount: 500,
          frequency: BenefitFrequency.YEARLY,
          percentage: 0,
        ...
        {
          description: '$150 x 2 Sapphire Reserve Tables Dining Credit',
          category: 'Dining',
          maxAmount: 300,
          frequency: BenefitFrequency.YEARLY,
          percentage: 0,
        ...
        {
          description: '$150 x 2 StubHub Credit',
          category: 'Event',
          maxAmount: 300,
          frequency: BenefitFrequency.YEARLY,
          percentage: 0,
        ...
        {
          description: '$250 Apple TV+/Music Credit',
          category: 'Stream',
          maxAmount: 250,
          frequency: BenefitFrequency.YEARLY,
          percentage: 0,
        ...
        {
          description: '$10 x 2 Monthly DoorDash Credit',
          category: 'Non-Food Delivery',
          maxAmount: 20,
          frequency: BenefitFrequency.MONTHLY,
          percentage: 0,
        },
        {
          description: '$10 Peloton Credit',
          category: 'Fit',
          maxAmount: 10,
          frequency: BenefitFrequency.MONTHLY,
          percentage: 0,
